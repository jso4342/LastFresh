...
* The following dependencies are not known to work with Spring Native: 'MyBatis Framework, Quartz Scheduler, Spring Boot DevTools, Spring Web Services'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 lastfresh:0.0.1-SNAPSHOT
```
